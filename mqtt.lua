...
m:on('connect', function(client)
  ...
  client:publish(node.chipid() .. '/reset_reason', reset_reason, 1, 0)
...
pub:register(60000, tmr.ALARM_AUTO, function()
  ...
  m:publish(node.chipid() .. '/temperature', sensors.temperature, 1, 0)
  m:publish(node.chipid() .. '/humidity',    sensors.humidity   , 1, 0)
  m:publish(node.chipid() .. '/io',          io.state           , 1, 0)
end)
